...
@ManagedBean
@ViewScoped
public class JovenesBean extends BotonesBean implements Serializable {
    ...
    public void postConstructor() {
        super.sinSeleccion();
        this.miembros = this.registroMiembroServicio.findAllJovenes();
